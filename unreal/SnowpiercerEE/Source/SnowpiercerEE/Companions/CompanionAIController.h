...
#include "SnowpiercerEE/Combat/SEECombatAIController.h"
...
//
// AI controller for companion characters. Extends SEECombatAIController with
// behavior mode support, corridor-aware navigation, and formation logic.
// ============================================================================

UCLASS()
class SNOWPIERCEREE_API ACompanionAIController : public ASEECombatAIController
{
	GENERATED_BODY()
