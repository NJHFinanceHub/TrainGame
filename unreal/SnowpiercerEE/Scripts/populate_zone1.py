...
# Imported SoundWave (no cue asset is generated by the pipeline)
AMBIENT_SOUND_CUE = "/Game/Audio/train_interior"
...
def populate():
    ...
    # Ensure Zone1_Tail is the loaded level (headless runs may start elsewhere)
    les = unreal.get_editor_subsystem(unreal.LevelEditorSubsystem)
    world = unreal.EditorLevelLibrary.get_editor_world()
    if not world or "Zone1_Tail" not in world.get_path_name():
        unreal.log("Loading /Game/Maps/Zone1_Tail ...")
    ...
    # Persist the populated level (required for headless runs)
    unreal.log("Saving Zone1_Tail ...")
    unreal.get_editor_subsystem(unreal.LevelEditorSubsystem).save_all_dirty_levels()
    unreal.log("Level saved.")
    unreal.log("")
    unreal.log("Next steps:")
    unreal.log("  1. Open Zone1_Tail map")
    unreal.log("  2. Press Play")
